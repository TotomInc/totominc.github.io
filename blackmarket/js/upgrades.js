...
var shootRewardUpgrades = [
    ...
    new Upgrade("Indoor Range II",                              15000,        			    function() { shoot[7] *= 2 }),
    ...
    new Upgrade("Faster Targets",	                            132500000,				    function() { shoot[7] *= 2.66 }),
    new Upgrade("Personal Trainer",	                            3850000000,				    function() { shoot[7] *= 2.88 }),
    new Upgrade("Camera Review System",		                    27500000000, 			    function() { shoot[7] *= 3 }),
    new Upgrade("Digital Impact System",		                5000000000000,			    function() { shoot[7] *= 3 }),
    new Upgrade("Indoor Range III",		                        25000000000000,			    function() { shoot[7] *= 2 }),
...
var methPriceUpgrades = [
    new Upgrade("Chemist",                          2500000,				    function() { drugMultiplier[1] *= 3 }),
    new Upgrade("Storage Equipment",                10000000,				    function() { drugMultiplier[1] *= 2 }),
    new Upgrade("Beakers",                          500000000,				    function() { drugMultiplier[1] *= 2 }),
    new Upgrade("Beakers II",                       2500000000,				    function() { drugMultiplier[1] *= 3 }),
    new Upgrade("Graduated Cylinders",		        99999000000,			    function() { drugMultiplier[1] *= 2 }),
    new Upgrade("Safety Equipment",		            5000000000000,			    function() { drugMultiplier[1] *= 3 }),
    new Upgrade("Chemist II",		                85000000000000,			    function() { drugMultiplier[1] *= 4 }),
    new Upgrade("Chemical Burner",		            950000000000000,		    function() { drugMultiplier[1] *= 3 }),
    new Upgrade("Storage Flask",		            5000000000000000,		    function() { drugMultiplier[1] *= 3 }),
    new Upgrade("Storage Flask II",		            50000000000000000,		    function() { drugMultiplier[1] *= 2 }),
    new Upgrade("+20 Chemists",		                500000000000000000,		    function() { drugMultiplier[1] *= 2 }),
    new Upgrade("Biologist",		                750000000000000000,		    function() { drugMultiplier[1] *= 3 }),
    new Upgrade("Cessna Transport Aircraft",		2500000000000000000,	    function() { drugMultiplier[1] *= 2 }),
    new Upgrade("+5 Biologists",		            12500000000000000000,	    function() { drugMultiplier[1] *= 2 }),
    new Upgrade("Transport Mules",		            50000000000000000000,	    function() { drugMultiplier[1] *= 3 }),
    new Upgrade("Brand New Equipment",		        321000000000000000000,	    function() { drugMultiplier[1] *= 2 }),
	new Upgrade("Tubes, Lots of Tubes",		        750000000000000000000,	    function() { drugMultiplier[1] *= 2 }),
	new Upgrade("High-Tech Lab",	                1500000000000000000000,	    function() { drugMultiplier[1] *= 2 }),
	new Upgrade("Ivy League Chemists",	            5000000000000000000000,	    function() { drugMultiplier[1] *= 3 }),
	new Upgrade("Amezcua State-of-the-Art Lab",	    10000000000000000000000,	function() { drugMultiplier[1] *= 2 })
];

var cocainePriceUpgradesOwned;
var cocainePriceUpgrades = [
    new Upgrade("Jungle Lab",                           30000000000,			    function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Small Chemical Lab",                   250000000000,			    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Packaging Machine",                    750000000000,     		    function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Chemical Press",                       1500000000000,    		    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Trash Can o'Mixing",                   5000000000000,			    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Gasoline Container",		            25000000000000,			    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Cocaine Base Filter",		            750000000000000,		    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Cocaine Drying Machine",		        3500000000000000,		    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Hydraulic Press",		                75000000000000000,		    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Microwave Oven",		                500000000000000000,		    function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Industrial Refrigerator",		        1000000000000000000,	    function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Kidnap more Workers",		            25000000000000000000,	    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Field Expansion I",		            50000000000000000000,	    function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Field Expansion II",		            125000000000000000000,	    function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Field Expansion III",		            654000000000000000000,	    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Field Expansion IV",		            1500000000000000000000,	    function() { drugMultiplier[2] *= 2 }),
	new Upgrade("Kitchen Upgrade",		                2500000000000000000000,	    function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Professional Underground Lab",		    5000000000000000000000,	    function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Field Expansion V",		            12500000000000000000000,	function() { drugMultiplier[2] *= 2 }),
    new Upgrade("Field Expansion VI",		            65400000000000000000000,	function() { drugMultiplier[2] *= 3 }),
    new Upgrade("Professional Underground Lab II",		150000000000000000000000,	function() { drugMultiplier[2] *= 2 })
];
