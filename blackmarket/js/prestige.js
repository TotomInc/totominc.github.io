var prestigeRanks = [
    ...
    new PrestigeRank("Gang Underboss",  			14, 100000000,  		400.00),
    ...
    new PrestigeRank("Mafia Underboss",		23,	100000000000,		5000.00),
    ...
    new PrestigeRank("Drug Emperor",				30,	20000000000000,		17000.00),
    new PrestigeRank("Legendary Druglord",			31,	50000000000000,		19000.00)
];
